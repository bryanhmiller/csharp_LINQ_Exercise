...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MinMax //.Min & .Max
    {
        ...
        {
            var maxValue = PracticeData[2].Students.Max(student => student.Birthday); /*FILL IN LINQ EXPRESSION*/ //HINT: Cohort3 is PracticeData[2]
        ...
        {
            var maxValue = PracticeData.Max(c => c.JuniorInstructors.Count())/*FILL IN LINQ EXPRESSION*/; 
