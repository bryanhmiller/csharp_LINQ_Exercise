...
namespace LINQ_Practice
{
         ...
         */
    {
        ...
        {
            var expected = PracticeData[0].Students.OrderByDescending(s => s.Birthday)/*FILL IN LINQ EXPRESSION*/.ToList(); //HINT: Cohort1 is PracticeData[0]
        ...
        {
            var expected = PracticeData[2].JuniorInstructors.OrderBy(ji => ji.LastName)/*FILL IN LINQ EXPRESSION*/.ToList();
