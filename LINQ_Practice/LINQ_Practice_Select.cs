...
namespace LINQ_Practice
{
     ...
     */
    {
        ...
        {
            var expected = PracticeData.Select(c => c.PrimaryInstructor)/*FILL IN LINQ EXPRESSION*/.ToList();
        ...
        {
            var expected = PracticeData.SelectMany(c => c.Students)/*FILL IN LINQ EXPRESSION*/.ToList();
        ...
        {
            var expected = PracticeData.Select(c => c.PrimaryInstructor.FirstName)/*FILL IN LINQ EXPRESSION*/.ToList();
        ...
        {
            var expected = PracticeData.Select(c => c.Name)/*FILL IN LINQ EXPRESSION*/.ToList();
