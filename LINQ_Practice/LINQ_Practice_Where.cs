...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_Where
    {
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(c => c.Active == true)/*FILL IN LINQ EXPRESSION*/.ToList(); 
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(c => c.FullTime == true)/*FILL IN LINQ EXPRESSION*/.ToList();
        ...
        {
            List<Cohort> ActualCohorts = PracticeData.Where(c => c.PrimaryInstructor.FirstName == "Jurnell")/*FILL IN LINQ EXPRESSION*/.ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.JuniorInstructors.Count() == 3)/*FILL IN LINQ EXPRESSION*/.ToList();
